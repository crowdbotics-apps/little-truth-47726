"""
Django settings for little_truth_47726 project.
...
ROOT_URLCONF = 'little_truth_47726.urls'
...
WSGI_APPLICATION = 'little_truth_47726.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "little_truth_47726 API",
    "DESCRIPTION": "API documentation for little_truth_47726 App",
    "VERSION": "v1",
}
